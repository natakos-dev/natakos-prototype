...
mixin _$ExpenseModel {
  ...
  DateTime get date => throw _privateConstructorUsedError; // tanggal
  String get category => throw _privateConstructorUsedError; // kategori
  String get description => throw _privateConstructorUsedError; // deskripsi
  double get amount => throw _privateConstructorUsedError; // jumlah
  String get paidTo => throw _privateConstructorUsedError; // dibayarKe
...
// dibayarKe
  ...
  @override
  String toString() {
    return 'ExpenseModel(id: $id, date: $date, category: $category, description: $description, amount: $amount, paidTo: $paidTo, paymentMethod: $paymentMethod)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, date, category, description,
      amount, paidTo, paymentMethod);
...
abstract class _ExpenseModel implements ExpenseModel {
  const factory _ExpenseModel(
      ...
      required final String paymentMethod}) = _$ExpenseModelImpl;
